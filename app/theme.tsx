...
import { themeItem } from "@/redux/action";
...
const theme = () => {
  ...
  const themeBtn = async (color) => {
    dispatch(themeItem(color));
    setThemeColor(color);
    router.back();
  };
    ...
    <View style={tw`h-full`}>
      ...
      <View style={tw``}>
        <TouchableOpacity
          onPress={() => themeBtn("")}
          style={tw`m-3 ${
            !themeColor ? "border-2 border-green-600" : ""
        ...
        <TouchableOpacity
          ...
          style={tw`m-3 p-2 ${
            themeColor == "pink" ? "border-2 border-green-600" : ""
        ...
        <TouchableOpacity
          ...
          style={tw`m-3 p-2 ${
            themeColor == "black" ? "border-2 border-green-600" : ""
          } bg-white shadow-lg rounded-lg`}
        >
          <View
        ...
        <TouchableOpacity
          ...
          style={tw`m-3 p-2 ${
            themeColor == "yellow" ? "border-2 border-green-600" : ""
          } bg-white shadow-lg rounded-lg`}
        >
          <View
